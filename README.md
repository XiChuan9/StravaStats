...
The current Canonical database is `strava-stats-v2`, physical IndexedDB V4, schema ID
`strava-stats-v2@4`, with thirteen stores. It is physically separate from the Legacy
